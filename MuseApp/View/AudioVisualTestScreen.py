...
class AudioVisualTestPage (MDScreen, Observer):
    ...
    def __init__(self, **kw):
        ...
        sound_path = os.path.join(os.path.dirname(__file__), os.pardir, "Assets", "tires.wav")
        print(sound_path)
        self.audio = SoundLoader.load(sound_path)
        Clock.schedule_once(self.start_time_elapsed, 5.42)
        Clock.schedule_once(self.play_audio, 60)
    ...
    Builder.load_file('View/audiovisualtestscreen.kv')
